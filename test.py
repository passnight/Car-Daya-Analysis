...
#     locationSet = location.address.split(", ")
#     data = {"省": "null", "市": "null", "自治区": "null", "特别行政区":"null", "else": "null"}
#     print(locationSet)
#     for item in locationSet:
#         if item.endswith("省"):
#             data["省"] = item
#         elif item.endswith("自治区"):
#             data["市"] = item
#         elif item.endswith("市"):
#             data["自治区"] = item
#         elif item.endswith("特别行政区"):
#             data["特别行政区"] = item
#         else:
#             data["else"] = item
#     if data["省"] != "null":
...
#     elif data["自治区"] != "null":
#         return data["自治区"]
#     elif data["特别行政区"] != "null":
#         return data["特别行政区"]
#     else:
#         return "南海诸岛"
# # initiate nominatim
# print(tansfromCityToProvince("澳门"))

# provinces = "河北省 、 山西省 、 辽宁省 、 吉林省 、 黑龙江省 、 江苏省 、 浙江省 、 安徽省 、 福建省 、 江西省 、 山东省 、 河南省 、 湖北省 、 湖南省 、 广东省 、 海南省 、 四川省 、 贵州省 、 云南省 、 陕西省 、 甘肃省 、 青海省 、 台湾省 、 内蒙古自治区 、 广西壮族自治区 、 西藏自治区 、 宁夏回族自治区 、 新疆维吾尔自治区 、 北京市 、 天津市 、 上海市"
# provinceList = provinces.split(' 、 ')
# for item in provinceList:
#     print("\"" + item + "\":0,")
# provinces = "重庆市 、 香港特别行政区 、 澳门特别行政区"
...
# print(tansfromCityToProvince(""))


import datetime
string = "Thu Jul 01 2021 00: 00: 00 GMT+0800 (GMT+08: 00)"
print(datetime.datetime.strftime(string))
