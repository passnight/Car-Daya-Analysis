...
if __name__ =="__main__":
    rootPath = "C:\\Users\\90643\\Desktop\\autoHome\\json\\"
    ...
    for json_s in listdir:
        ...
        content = ""
        #读取样式文件
        spansPath = "C:\\Users\\90643\\Desktop\\autoHome\\content\\"+json_s.title()+".html"
        # print(spansPath)
        ...
        print(jso)
        fi = open("C:\\Users\\90643\\Desktop\\autoHome\\newJson\\"+json_s.title(),"a",encoding="utf-8")
        fi.write(jso)
        fi.close()