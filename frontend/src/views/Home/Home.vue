...
export default {
  ...
  methods: {
    ...
    drawMap() {
      axios.get("../../public/json/ChinaMap.json").then((response) => {
  ...
  mounted() {
    axios.get("../../../public/data/CarModel.json").then((response) => {
      this.carModels = response.data.carModelList;
    });
    axios.get("../../../public/data/SellingData.json").then((response) => {
